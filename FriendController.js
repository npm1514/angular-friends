var app = angular.module("theFacebook");
app.controller("FriendController", function($scope){
	...
	$scope.friends = [{
	    "name": "Nick Marucci",
	    "pic_square": "https://scontent-ord1-1.xx.fbcdn.net/hphotos-xaf1/v/t1.0-9/10985380_10153566801272962_8901904430636911869_n.jpg?oh=3e853b59537ab7820e355045ebd3f7ae&oe=571B60ED",
	    "current_location": {
	      "city": "Provo",
	      "state": "Utah",
	    ...
	    "status": {
	      "message": "Life is wonderful!",
	      "time": "1381225766",
	      "status_id": "10101839814247153",
	      "comment_count": "3"
	    },
	    "friend_count": 328,
	    "$$hashKey": "#mountain-yodle"
	  },
	  {
	    "name": "Preston McNeil",
